    ...
    <div className={`min-h-screen transition-colors duration-300 ${
      ...
      <div className="max-w-lg mx-auto px-4 py-6">
          ...
          <div className={`rounded-3xl p-6 border ${
              ...
              {options.map((option, index) => (
                <div key={index} className="flex items-center gap-3">
                  ...
                  <input
                    ...
                    className={`flex-1 p-3 rounded-2xl border transition-all duration-200 ${
                      isDarkMode
                        ? 'bg-gray-800 border-gray-600 text-white placeholder-gray-400'
                        : 'bg-white border-gray-300 text-gray-900 placeholder-gray-500'
                    } focus:outline-none focus:border-blue-500`}
            ...
            {options.length < 4 && (
              <button
                type="button"
                onClick={addOption}
                className={`w-full mt-4 py-3 rounded-2xl border-2 border-dashed transition-all duration-200 flex items-center justify-center gap-2 ${
                  isDarkMode
        ...
        {question.trim() && options.filter(o => o.trim()).length >= 2 && (
          <div className={`mt-8 rounded-3xl p-6 border ${
            isDarkMode ? 'bg-gray-900 border-gray-700' : 'bg-white border-gray-200'
          }`}>
