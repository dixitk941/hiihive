...
import { FiThumbsUp, FiMessageCircle, FiShare } from 'react-icons/fi'; // Import the icons
...
const PostPage = ({ match }) => {
  ...
  // Handle user avatar click to navigate to the profile page
      ...
      {user && post ? (
        <div className="bg-white rounded-lg shadow-lg mb-4 w-full sm:max-w-[500px] mx-auto">
          ...
          <div className="flex items-center p-4">
            ...
            />
            <div className="ml-3">
              <p className="font-semibold text-gray-800">{post.userFullName}</p>
